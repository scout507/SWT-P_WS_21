...
public class Turret : NetworkBehaviour
{
    ...
    public void Shoot()
    {
        ...
        if (Physics.Raycast(rayOrigin, direction, out hit, weaoponRange, ~0))
        {
            ...
            {
                CmdShootMonster(hit.collider.gameObject.transform.parent.gameObject);
            }
            else
            {
    ...
    /// <summary>
    /// Method is called when a wall is hit and calls the RPC Method
    /// </summary>
    ...
    {
        monster.GetComponent<MonsterController>().TakeDamage(turretDamage);
    }


    /// <summary>
    /// Method is called when player is hit
    /// </summary>
